...
if __name__ == "__main__":
    ...
    # Test edge cases (optional - comment out if you want)
    print("\nEdge case tests:")
    try:
        calculate_electricity_emissions(-100, "ARKANSAS")
    except ValueError as e:
        print(f"✓ Caught negative kWh: {e}")
    
    try:
        calculate_electricity_emissions(850, "FLORIDA")
    except ValueError as e:
